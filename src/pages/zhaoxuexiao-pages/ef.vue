<template>
  <div class="over">
    <section class="b-box">
      <div class="center">
        <div class="text">
          <a href="javascript:" class="textA">EF英孚教育青少儿英语</a>
          <div class="first">
          ...
          <span>学校地址：
                        <span>广州市海珠区赤岗北路118号四季天地1层<br></span>
                    </span>
          <span>报名电话：
        ...
        <div id="goods" class="tupian">
          <div>
            <img src="~@/assets/IMG/xx5_big.jpg" id="bigimg">
          </div>
          <div id="goods_img" class="xiao">
            <ul>
              <li> <img src="~@/assets/IMG/xx5.jpg" alt=""></li>
              <li><img src="~@/assets/IMG/t1.jpg" alt=""></li>
              <li><img src="~@/assets/IMG/c4.jpg" alt=""></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="b-box">
          <div class="class-left">
            ...
            <div class="left-botton">
              <div class="first">
                <h2>学员评价</h2>
                <router-link to="/zhaoxuexiao/ef/allcomments" active-class="bgblue">全部（100）</router-link>
                <router-link to="/zhaoxuexiao/ef/newcomments" active-class="bgblue">全新</router-link>
              </div>
