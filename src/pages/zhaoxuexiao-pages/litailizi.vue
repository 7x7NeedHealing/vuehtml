<template>
  <div class="over">
    <section class="b-box">
      <div class="center">
        <div class="text">
          <a href="javascript:" class="textA">丽态丽姿·形体仪态礼仪</a>
          <div class="first">
          ...
          <span>学校地址：
                        <span>天河区华强路3号富力盈力大厦南塔617室<br></span>
                    </span>
          <span>报名电话：
        ...
        <div id="goods" class="tupian">
          <div>
            <img src="~@/assets/IMG/2_big.jpg" id="bigimg" alt="" style="left:34%">
          </div>
          <div id="goods_img" class="xiao">
            <ul>
              <li><img src="~@/assets/IMG/2.jpg" alt=""></li>
              <li><img src="~@/assets/IMG/tt1.jpg" alt=""></li>
              <li><img src="~@/assets/IMG/tt3.jpg" alt=""></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="b-box">
          <div class="class-left">
            ...
            <div class="left-botton">
              <div class="first">
                <h2>学员评价</h2>
                <router-link to="/zhaoxuexiao/litailizi/allcomments" active-class="bgblue">全部（100）</router-link>
                <router-link to="/zhaoxuexiao/litailizi/newcomments" active-class="bgblue">全新</router-link>
              </div>
