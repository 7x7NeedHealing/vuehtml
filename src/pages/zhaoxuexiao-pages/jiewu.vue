<template>
  <div class="over">
    <section class="b-box">
      <div class="center">
        <div class="text">
          <a href="javascript:" class="textA">艺尚少儿模特艺术街舞</a>
          <div class="first">
          ...
          <span>学校地址：
                        <span>广州市珠江新城高德置地东广场三楼338铺<br></span>
                    </span>
          <span>报名电话：
        ...
        <div class="b-box">
          <div class="class-left">
            ...
            <div class="left-botton">
              <div class="first">
                <h2>学员评价</h2>
                <router-link to="/zhaoxuexiao/jiewu/allcomments" class="routerA" active-class="bgblue">全部（100）</router-link>
                <router-link to="/zhaoxuexiao/jiewu/newcomments" class="routerA" active-class="bgblue">全新</router-link>
              </div>
              <!--显示区域-->
