<template>
  <div class="over">
    <section class="b-box">
      <div class="center">
        <div class="text">
          <a href="javascript:" class="textA">童程童美教育</a>
          <div class="first">
        ...
        <div class="b-box">
          <div class="class-left">
            ...
            <div class="left-botton">
              <div class="first">
                <h2>学员评价</h2>
                <router-link to="/zhaoxuexiao/tongcengjiaoyu/allcomments" class="routerA" active-class="bgblue">全部（100）</router-link>
                <router-link to="/zhaoxuexiao/tongcengjiaoyu/newcomments" class="routerA" active-class="bgblue">全新</router-link>
              </div>
              <!--显示区域-->
